...
# 1. в файле пустые значения
print(df.isnull().sum())

# 2. median_house_value где median_income < 2
print(df[df['median_income'] < 2]['median_house_value'])


# 3. данные в первых 2 столбцах
print(df[['longitude', 'latitude']])
print(df.iloc[:, :2])  # all rows and 2 columns

# 4. данные где housing_median_age < 20 и median_house_value > 70000
